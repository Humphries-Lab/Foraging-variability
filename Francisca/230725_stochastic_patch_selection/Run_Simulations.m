...
File = '/Users/exs165/Dropbox/foraging/code/Francisca/230725_stochastic_patch_selection/Model_options.xlsx';
%File = 'C:\Users\lpzfp\OneDrive - The University of Nottingham\FPP Documents\Matlab code\My_code\Model_options.xlsx';
...
for n=1:length(ID)
    ...
    LTMean{n} = squeeze(mean(tempM,3,'omitnan'));
    LTSEM{n} = squeeze(std(tempM,[],3,'omitnan'))./sqrt(NSim);     
end
