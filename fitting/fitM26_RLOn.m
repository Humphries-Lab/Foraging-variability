function [minNLL, minNLLFitParams, BIC, AIC, FitParams, NLLEval, StartParams] = fitM26_RLOn(SubjData, Env, nStarts, maxAlpha)
...
%% Calculate BIC/AIC
[~, out] = NLL_M26_RLOn([0 0 1], Env, SubjData); % get the number of data points that were fit to (parameter values don't matter here)
