function [minNLL, minNLLFitParams, BIC, AIC, FitParams, NLLEval, StartParams] = fitM21_RLOff(SubjData, Env, nStarts, maxAlpha)
...
parfor ii = 1:nStarts
    params0 = [0.001+rand(1,1)*(maxAlpha(1)-0.001), 0.001+rand(1,1)*(maxAlpha(2)-0.001), exprnd(10)]; % choose start parameters
...
%% Calculate BIC/AIC
[~, out] = NLL_M21_RLOff([0 0 1], Env, SubjData); % get the number of data points that were fit to (parameter values don't matter here)
