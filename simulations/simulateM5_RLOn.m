function [out] = simulateM5_RLOn(params, Block, Env)

% simulateM5_RLOn simulates an agent completing the Le Heron milk foraging 
% task according to params

% out = simulateM5_RLOn(PARAMS, BLOCK, ENV) simulates data given params:
