function [out] = simulateM3_RLOn(params, Block, Env)
% simulateM3_RLOn simulates an agent completing the Le Heron milk foraging 
% task according to params

% out = simulateM3_RLOn(PARAMS, BLOCK, ENV) simulates data given params:
...
QStay = zeros(Env.BlockTime+1,1); % Q-table for staying - single Q - 'single' patch sequences
