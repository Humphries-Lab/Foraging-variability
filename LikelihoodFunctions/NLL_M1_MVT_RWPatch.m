function [NegLogLikelihood, out] = NLL_M1_MVT_RWPatch(params, Env, SubjData)
%% Set up
...
AlphaPatchRR = params(1); % average RR learning rate
...
PatchRPE = zeros(BlockTime+1,1); % reward prediction error
EstimatedPatchRR = zeros(BlockTime+1, 1); % estimated patchRR
...
out.PatchRPE = PatchRPE(1:BlockTime);
