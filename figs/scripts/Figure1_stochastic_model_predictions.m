...
print([export_path 'fig1_MVT_RR'],'-dsvg')
print([overleaf_path, 'fig1/', 'fig1_MVT_RR'],'-dsvg')
...
FormatFig_For_Export(gcf,fontsize,fontname,widths.axis)
print([export_path 'fig1_expectedLT_softmax_beta'],'-dsvg')
print([overleaf_path, 'fig1/', 'fig1_expectedLT_softmax_beta'],'-dsvg')
...
FormatFig_For_Export(gcf,fontsize,fontname,widths.axis)
print([export_path 'fig1_LT_softmax'],'-dsvg')
print([overleaf_path, 'fig1/', 'fig1_LT_softmax'],'-dsvg')
...
FormatFig_For_Export(gcf,fontsize,fontname,widths.axis)
print([export_path 'fig1_expectedLT_softmax_beta_overharvesting'],'-dsvg')
print([overleaf_path, 'fig1/', 'fig1_expectedLT_softmax_beta_overharvesting'],'-dsvg')
...
FormatFig_For_Export(gcf,fontsize,fontname,widths.axis)
print([export_path 'fig1_LT_softmax_overharvesting'],'-dsvg')
print([overleaf_path, 'fig1/', 'fig1_LT_softmax_overharvesting'],'-dsvg')
...
xlabel('Beta (higher = exploit)')
ylabel('SD leaving times'); 
ylim([0 10])

FormatFig_For_Export(gcf,fontsize,fontname,widths.axis)
print([export_path 'fig1_expectedSD_softmax_beta'],'-dsvg')
print([overleaf_path, 'fig1/', 'fig1_expectedSD_softmax_beta'],'-dsvg')
...
FormatFig_For_Export(gcf,fontsize,fontname,widths.axis)
print([export_path 'fig1_expectedLT_e_greedy'],'-dsvg')
print([overleaf_path, 'fig1/', 'fig1_expectedLT_e_greedy'],'-dsvg')
...
FormatFig_For_Export(gcf,fontsize,fontname,widths.axis)
print([export_path 'fig1_LT_e_greedy'],'-dsvg')
print([overleaf_path, 'fig1/', 'fig1_LT_e_greedy'],'-dsvg')
